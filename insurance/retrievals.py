...
class InsuranceDataLoader(DataLoader):
    ...
    def get_question(self):
        ...
        questions_example = questions_example[questions_example['category'] == 'insurance']
        # questions_example['query'] = questions_example['query'].apply(lambda x: x.replace('重新', '補換'))
    ...
    def get_answer(self):
        ...
        ground_truths_example = ground_truths_example[ground_truths_example['category'] == 'insurance']
    ...
    def process_pdf(self, pdf_path):
        ...
        return int(pdf_path.stem), chunks
...
class DataPreprocessor:
    ...
    * albert-base + BM25: 1 acc.
    * bert-tiny + BM25: 0.98 acc.
    * albert-tiny + BM25: 1 acc.
    """
